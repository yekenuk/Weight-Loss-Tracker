...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.yk-uikUIkitLightbox = factory(global.yk-uikUIkit.util));
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    uikitUtil.toggleClass(el, 'yk-uik-invisible', this$1$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1$1.maxIndex));
                });
    ...
    var LightboxPanel = {
        ...
        methods: {
            ...
            showControls: function() {
                ...
                uikitUtil.addClass(this.$el, 'yk-uik-active', 'yk-uik-transition-active');

            },

            hideControls: function() {
                uikitUtil.removeClass(this.$el, 'yk-uik-active', 'yk-uik-transition-active');
            }
    ...
    function install(yk-uikUIkit, Lightbox) {
    ...
    if (typeof window !== 'undefined' && window.yk-uikUIkit) {
        window.yk-uikUIkit.component('lightbox', Component);
    }
