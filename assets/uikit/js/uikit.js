/*! yk-uikUIkit 3.6.22 | https://www.getuikit.com | (c) 2014 - 2021 YOOtheme | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('uikit', factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.yk-uikUIkit = factory());
    ...
    var parseCssVar = memoize(function (name) {
        /* usage in css: .yk-uik-name:before { content:"xyz" } */

        var element = append(document.documentElement, document.createElement('div'));

        addClass(element, ("yk-uik-" + name));
    ...
    function getCssVar(name) {
        return !isIE
            ? getStyles(document.documentElement).getPropertyValue(("--yk-uik-" + name))
            : parseCssVar(name);
    }
    ...
    function transition(element, props, duration, timing) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                once(element, 'transitionend transitioncanceled', function (ref) {
                    ...
                    clearTimeout(timer);
                    removeClass(element, 'yk-uik-transition');
                    css(element, {
                        transitionProperty: '',
                        transitionDuration: '',
                ...
                addClass(element, 'yk-uik-transition');
                css(element, assign({
    ...
    var Transition = {
        ...
        inProgress: function(element) {
            return hasClass(element, 'yk-uik-transition');
        }

    };

    var animationPrefix = 'yk-uik-animation-';
    ...
    function animate$1(element, animation, duration, origin, out) {
        ...
        return Promise$1.all(toNodes(element).map(function (element) { return new Promise$1(function (resolve, reject) {
                ...
                if (startsWith(animation, animationPrefix)) {
                    origin && addClass(element, ("yk-uik-transform-origin-" + origin));
    ...
    */
    ...
    function globalAPI (yk-uikUIkit) {

        var DATA = yk-uikUIkit.data;

        yk-uikUIkit.use = function (plugin) {
        ...
        yk-uikUIkit.mixin = function (mixin, component) {
            component = (isString(component) ? yk-uikUIkit.component(component) : component) || this;
            component.options = mergeOptions(component.options, mixin);
        };

        yk-uikUIkit.extend = function (options) {

            options = options || {};

            var Super = this;
            var Sub = function yk-uikUIkitComponent(options) {
                this._init(options);
            };
        ...
        yk-uikUIkit.update = function (element, e) {
        ...
        var container;
        Object.defineProperty(yk-uikUIkit, 'container', {
    ...
    function hooksAPI (yk-uikUIkit) {

        yk-uikUIkit.prototype._callHook = function (hook) {
            var this$1$1 = this;
        ...
        yk-uikUIkit.prototype._callConnected = function () {
        ...
        yk-uikUIkit.prototype._callDisconnected = function () {
        ...
        yk-uikUIkit.prototype._callUpdate = function (e) {
            var this$1$1 = this;
        ...
        yk-uikUIkit.prototype._callWatches = function () {
            var this$1$1 = this;
    ...
    function stateAPI (yk-uikUIkit) {

        var uid = 0;

        yk-uikUIkit.prototype._init = function (options) {
        ...
        yk-uikUIkit.prototype._initData = function () {
        ...
        yk-uikUIkit.prototype._initMethods = function () {
        ...
        yk-uikUIkit.prototype._initComputeds = function () {
        ...
        yk-uikUIkit.prototype._initProps = function (props) {
        ...
        yk-uikUIkit.prototype._initEvents = function () {
            var this$1$1 = this;
        ...
        yk-uikUIkit.prototype._unbindEvents = function () {
            this._events.forEach(function (unbind) { return unbind(); });
            delete this._events;
        };

        yk-uikUIkit.prototype._initObservers = function () {
            this._observers = [
        ...
        yk-uikUIkit.prototype._disconnectObservers = function () {
    ...
    function instanceAPI (yk-uikUIkit) {

        var DATA = yk-uikUIkit.data;

        yk-uikUIkit.prototype.$create = function (component, element, data) {
            return yk-uikUIkit[component](element, data);
        };

        yk-uikUIkit.prototype.$mount = function (el) {
        ...
        yk-uikUIkit.prototype.$reset = function () {
            this._callDisconnected();
            this._callConnected();
        };

        yk-uikUIkit.prototype.$destroy = function (removeEl) {
        ...
        yk-uikUIkit.prototype.$emit = function (e) {
            this._callUpdate(e);
        };

        yk-uikUIkit.prototype.$update = function (element, e) {
            if ( element === void 0 ) element = this.$el;

            yk-uikUIkit.update(element, e);
        };

        yk-uikUIkit.prototype.$getComponent = yk-uikUIkit.getComponent;

        var componentName = memoize(function (name) { return yk-uikUIkit.prefix + hyphenate(name); });
        Object.defineProperties(yk-uikUIkit.prototype, {

            $container: Object.getOwnPropertyDescriptor(yk-uikUIkit, 'container'),
    ...
    function componentAPI (yk-uikUIkit) {

        var DATA = yk-uikUIkit.data;

        var components = {};

        yk-uikUIkit.component = function (name, options) {
            ...
            if (!options) {
                ...
                if (isPlainObject(components[name])) {
                    components[name] = yk-uikUIkit.extend(components[name]);
                }
            ...
            yk-uikUIkit[name] = function (element, data) {
                var i = arguments.length, argsArray = Array(i);
                while ( i-- ) argsArray[i] = arguments[i];


                var component = yk-uikUIkit.component(name);
                ...
                function init(element) {
                    ...
                    var instance = yk-uikUIkit.getComponent(element, name);
            ...
            if (opt.install) {
                opt.install(yk-uikUIkit, opt, name);
            }

            if (yk-uikUIkit._initialized && !opt.functional) {
                fastdom.read(function () { return yk-uikUIkit[name](("[yk-uik-" + id + "],[data-yk-uik-" + id + "]")); });
            }

            return components[name] = isPlainObject(options) ? opt : options;
        };

        yk-uikUIkit.getComponents = function (element) { return element && element[DATA] || {}; };
        yk-uikUIkit.getComponent = function (element, name) { return yk-uikUIkit.getComponents(element)[name]; };

        yk-uikUIkit.connect = function (node) {
        ...
        yk-uikUIkit.disconnect = function (node) {
            for (var name in node[DATA]) {
    ...
    var getComponentName = memoize(function (attribute) {
        return startsWith(attribute, 'yk-uik-') || startsWith(attribute, 'data-yk-uik-')
            ? camelize(attribute.replace('data-yk-uik-', '').replace('yk-uik-', ''))
            : false;
    });

    var yk-uikUIkit = function (options) {
        this._init(options);
    };

    yk-uikUIkit.util = util;
    yk-uikUIkit.data = '__uikit__';
    yk-uikUIkit.prefix = 'yk-uik-';
    yk-uikUIkit.options = {};
    yk-uikUIkit.version = '3.6.22';

    globalAPI(yk-uikUIkit);
    hooksAPI(yk-uikUIkit);
    stateAPI(yk-uikUIkit);
    componentAPI(yk-uikUIkit);
    instanceAPI(yk-uikUIkit);

    function Core (yk-uikUIkit) {
        ...
        var handleResize = function () {
            ...
            yk-uikUIkit.update(null, 'resize');
        };
        ...
        on(window, 'scroll', function (e) {
            ...
            yk-uikUIkit.update(null, e.type);
        ...
        on(document, 'animationstart', function (ref) {
            ...
            if ((css(target, 'animationName') || '').match(/^yk-uik-.*(left|right)/)) {
    ...
    function boot (yk-uikUIkit) {

        var connect = yk-uikUIkit.connect;
        var disconnect = yk-uikUIkit.disconnect;
        ...
        function applyAttributeMutation(ref) {
            ...
            if (!name || !(name in yk-uikUIkit)) {
                return;
            }

            if (hasAttr(target, attributeName)) {
                yk-uikUIkit[name](target);
                return;
            }

            var component = yk-uikUIkit.getComponent(target, name);
    ...
    var Togglable = {
        ...
        data: {
            ...
            origin: false,
            transition: 'linear',
            clsEnter: 'yk-uik-togglabe-enter',
            clsLeave: 'yk-uik-togglabe-leave',
    ...
    var Accordion = {
        ...
        data: {
            ...
            multiple: false,
            clsOpen: 'yk-uik-open',
            toggle: '> .yk-uik-accordion-title',
            content: '> .yk-uik-accordion-content',
            transition: 'ease',
            offset: 0
        },
    ...
    var drop = {
        ...
        data: {
            ...
            delayHide: 800,
            clsDrop: false,
            animation: ['yk-uik-animation-fade'],
            cls: 'yk-uik-open'
        },
        ...
        computed: {
            ...
            clsDrop: function(ref) {
                ...
                return clsDrop || ("yk-uik-" + (this.$options.name));
            },
    ...
    var Margin = {
        ...
        data: {
            margin: 'yk-uik-margin-small-top',
            firstColumn: 'yk-uik-first-column'
        },
    ...
    var grid = {
        ...
        data: {
            margin: 'yk-uik-grid-margin',
            clsStack: 'yk-uik-grid-stack',
            masonry: false,
            parallax: 0
        },

        connected: function() {
            this.masonry && addClass(this.$el, 'yk-uik-flex-top yk-uik-flex-wrap-top');
        },
    ...
    function applyAnimation(el) {
        ...
        if (length) {
            el.style.setProperty('--yk-uik-animation-stroke', length);
        }
    ...
    var Slidenav = {
        ...
        beforeConnect: function() {
            addClass(this.$el, 'yk-uik-slidenav');
        },
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'yk-uik-slidenav-large')
                    ? (icon + "-large")
                    : icon;
            }
    ...
    var Search = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'yk-uik-search-icon') && parents($el, '.yk-uik-search-large').length
                    ? 'search-large'
                    : parents($el, '.yk-uik-search-navbar').length
                        ? 'search-navbar'
                        : icon;
            }
    ...
    var Close = {
        ...
        computed: {
            ...
            icon: function() {
                return ("close-" + (hasClass(this.$el, 'yk-uik-close-large') ? 'large' : 'icon'));
            }
    ...
    var parsed = {};
    function install$3(yk-uikUIkit) {
        yk-uikUIkit.icon.add = function (name, svg) {
            var obj;
            ...
            if (yk-uikUIkit._initialized) {
                apply$1(document.body, function (el) { return each(yk-uikUIkit.getComponents(el), function (cmp) {
    ...
    var leader = {
        ...
        data: {
            fill: '',
            clsWrapper: 'yk-uik-leader-fill',
            clsHide: 'yk-uik-leader-hide',
            attrFill: 'data-fill'
        },
    ...
    var modal = {
        ...
        data: {
            clsPage: 'yk-uik-modal-page',
            selPanel: '.yk-uik-modal-dialog',
            selClose: '.yk-uik-modal-close, .yk-uik-modal-close-default, .yk-uik-modal-close-outside, .yk-uik-modal-close-full'
        },
        ...
        events: [

            {
                ...
                handler: function() {
                    ...
                    if (hasClass(this.panel, 'yk-uik-margin-auto-vertical')) {
                        addClass(this.$el, 'yk-uik-flex');
                    } else {
...

            {
                ...
                handler: function() {
                    ...
                    css(this.$el, 'display', '');
                    removeClass(this.$el, 'yk-uik-flex');
    ...
    function install$2(ref) {
        ...
        modal.dialog = function (content, options) {
            ...
            var dialog = modal(
                ("<div class=\"yk-uik-modal\"> <div class=\"yk-uik-modal-dialog\">" + content + "</div> </div>"),
                options
            );
        ...
        modal.alert = function (message, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<div class=\"yk-uik-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"yk-uik-modal-footer yk-uik-text-right\"> <button class=\"yk-uik-button yk-uik-button-primary yk-uik-modal-close\" autofocus>" + (labels.ok) + "</button> </div>");
            },
                options,
        ...
        modal.confirm = function (message, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<form> <div class=\"yk-uik-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"yk-uik-modal-footer yk-uik-text-right\"> <button class=\"yk-uik-button yk-uik-button-default yk-uik-modal-close\" type=\"button\">" + (labels.cancel) + "</button> <button class=\"yk-uik-button yk-uik-button-primary\" autofocus>" + (labels.ok) + "</button> </div> </form>");
            },
                options,
        ...
        modal.prompt = function (message, value, options) {
            return openDialog(
                function (ref) {
                    ...
                    return ("<form class=\"yk-uik-form-stacked\"> <div class=\"yk-uik-modal-body\"> <label>" + (isString(message) ? message : html(message)) + "</label> <input class=\"yk-uik-input\" value=\"" + (value || '') + "\" autofocus> </div> <div class=\"yk-uik-modal-footer yk-uik-text-right\"> <button class=\"yk-uik-button yk-uik-button-default yk-uik-modal-close\" type=\"button\">" + (labels.cancel) + "</button> <button class=\"yk-uik-button yk-uik-button-primary\">" + (labels.ok) + "</button> </div> </form>");
            },
                options,
    ...
    var navbar = {
        ...
        data: {
            dropdown: '.yk-uik-navbar-nav > li',
            align: !isRtl ? 'left' : 'right',
            clsDrop: 'yk-uik-navbar-dropdown',
            mode: undefined,
            offset: undefined,
            delayShow: undefined,
            delayHide: undefined,
            ...
            duration: 200,
            forceHeight: true,
            selMinHeight: '.yk-uik-navbar-nav > li > a, .yk-uik-navbar-item, .yk-uik-navbar-toggle'
        },
        ...
        computed: {
            ...
            dropbar: {
                ...
                get: function(ref) {
                    ...
                    dropbar = this._dropbar || query(dropbar, this.$el) || $('+ .yk-uik-navbar-dropbar', this.$el);
                ...
                watch: function(dropbar) {
                    addClass(dropbar, 'yk-uik-navbar-dropbar');
                },
...

            {
                ...
                handler: function(_, ref) {
                    ...
                    if (this.dropbarMode === 'slide') {
                        addClass(this.dropbar, 'yk-uik-navbar-dropbar-slide');
                    }
    ...
    var offcanvas = {
        ...
        data: {
            ...
            flip: false,
            overlay: false,
            clsPage: 'yk-uik-offcanvas-page',
            clsContainer: 'yk-uik-offcanvas-container',
            selPanel: '.yk-uik-offcanvas-bar',
            clsFlip: 'yk-uik-offcanvas-flip',
            clsContainerAnimation: 'yk-uik-offcanvas-container-animation',
            clsSidebarAnimation: 'yk-uik-offcanvas-bar-animation',
            clsMode: 'yk-uik-offcanvas',
            clsOverlay: 'yk-uik-offcanvas-overlay',
            selClose: '.yk-uik-offcanvas-close',
            container: false
        },
    ...
    var overflowAuto = {
        ...
        data: {
            selContainer: '.yk-uik-modal',
            selContent: '.yk-uik-modal-dialog'
        },
    ...
    var responsive = {
        ...
        connected: function() {
            addClass(this.$el, 'yk-uik-responsive-width');
        },
    ...
    var scrollspy = {
        ...
        data: function () { return ({
            ...
            repeat: false,
            delay: 0,
            inViewClass: 'yk-uik-scrollspy-inview'
        }); },
...

            {
                ...
                read: function(data$1) {
                    ...
                    this.elements.forEach(function (el) {
                        ...
                        if (!el[stateKey]) {
                            el[stateKey] = {cls: data(el, 'yk-uik-scrollspy-class') || this$1$1.cls};
                        }
        ...
        methods: {
            ...
            toggle: function(el, inview) {
                ...
                if (/\byk-uik-animation-/.test(state.cls)) {
                    state.off = once(el, 'animationcancel animationend', function () { return removeClasses(el, 'yk-uik-animation-\\w*'); }
                    );
                }
    ...
    var sticky = {
        ...
        data: {
            ...
            offset: 0,
            animation: '',
            clsActive: 'yk-uik-active',
            clsInactive: '',
            clsFixed: 'yk-uik-sticky-fixed',
            clsBelow: 'yk-uik-sticky-below',
            selTarget: '',
            widthElement: false,
            showOnUp: false,
            targetOffset: false
        ...
        connected: function() {
            this.placeholder = $('+ .yk-uik-sticky-placeholder', this.$el) || $('<div class="yk-uik-sticky-placeholder"></div>');
            this.isFixed = false;
            this.isActive = false;
        },
    ...
    var Switcher = {
        ...
        data: {
            connect: '~.yk-uik-switcher',
            toggle: '> * > :first-child',
            active: 0,
            swiping: true,
            cls: 'yk-uik-active',
            attrItem: 'yk-uik-switcher-item'
        },
        ...
        computed: {
            ...
            toggles: {
                ...
                get: function(ref, $el) {
                    ...
                    return $$(toggle, $el).filter(function (el) { return !matches(el, '.yk-uik-disabled *, .yk-uik-disabled, [disabled]'); });
                },
    ...
    var tab = {
        ...
        data: {
            media: 960,
            attrItem: 'yk-uik-tab-item'
        },

        connected: function() {

            var cls = hasClass(this.$el, 'yk-uik-tab-left')
                ? 'yk-uik-tab-left'
                : hasClass(this.$el, 'yk-uik-tab-right')
                    ? 'yk-uik-tab-right'
                    : false;
    ...
    // register components
    each(components$1, function (component, name) { return yk-uikUIkit.component(name, component); }
    );

    // core functionality
    yk-uikUIkit.use(Core);
    ...
    var countdown = {
        ...
        data: {
            date: '',
            clsWrapper: '.yk-uik-countdown-%unit%'
        },
    ...
    var clsLeave = 'yk-uik-transition-leave';
    var clsEnter = 'yk-uik-transition-enter';
    ...
    function fade(action, target, duration, stagger) {
        ...
        var enterFn = wrapIndexFn(function () {
            ...
            // Ensure yk-uikUIkit updates have propagated
    ...
    var filter = {
        ...
        data: {
            target: null,
            selActive: false,
            attrItem: 'yk-uik-filter-control',
            cls: 'yk-uik-active',
            duration: 250
        },
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'yk-uik-invisible', this$1$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1$1.maxIndex));
                });
    ...
    var Slideshow = {
        ...
        data: {
            animation: 'slide',
            clsActivated: 'yk-uik-transition-active',
    ...
    var LightboxPanel = {
        ...
        data: function () { return ({
            ...
            items: [],
            cls: 'yk-uik-open',
            clsPage: 'yk-uik-lightbox-page',
            selList: '.yk-uik-lightbox-items',
            attrItem: 'yk-uik-lightbox-item',
            selClose: '.yk-uik-close-large',
            selCaption: '.yk-uik-lightbox-caption',
            pauseOnHover: false,
            velocity: 2,
            Animations: Animations$1,
            template: "<div class=\"yk-uik-lightbox yk-uik-overflow-hidden\"> <ul class=\"yk-uik-lightbox-items\"></ul> <div class=\"yk-uik-lightbox-toolbar yk-uik-position-top yk-uik-text-right yk-uik-transition-slide-top yk-uik-transition-opaque\"> <button class=\"yk-uik-lightbox-toolbar-icon yk-uik-close-large\" type=\"button\" yk-uik-close></button> </div> <a class=\"yk-uik-lightbox-button yk-uik-position-center-left yk-uik-position-medium yk-uik-transition-fade\" href yk-uik-slidenav-previous yk-uik-lightbox-item=\"previous\"></a> <a class=\"yk-uik-lightbox-button yk-uik-position-center-right yk-uik-position-medium yk-uik-transition-fade\" href yk-uik-slidenav-next yk-uik-lightbox-item=\"next\"></a> <div class=\"yk-uik-lightbox-toolbar yk-uik-lightbox-caption yk-uik-position-bottom yk-uik-text-center yk-uik-transition-slide-bottom yk-uik-transition-opaque\"></div> </div>"
        }); },
        ...
        events: [
...

            {
                ...
                handler: function(_, item) {
                    ...
                    this.setItem(item, '<span yk-uik-spinner></span>');
                    ...
                    var iframeAttrs = {
                        ...
                        'yk-uik-responsive': '',
                        'yk-uik-video': ("" + (this.videoAutoplay))
                    };
        ...
        methods: {
            ...
            setError: function(item) {
                this.setItem(item, '<span yk-uik-icon="icon: bolt; ratio: 2"></span>');
            },
            ...
            showControls: function() {
                ...
                addClass(this.$el, 'yk-uik-active', 'yk-uik-transition-active');

            },

            hideControls: function() {
                removeClass(this.$el, 'yk-uik-active', 'yk-uik-transition-active');
            }
    ...
    var lightbox = {
        ...
        events: [

            {
                ...
                delegate: function() {
                    return ((this.toggle) + ":not(.yk-uik-disabled)");
                },
    ...
    function install$1(yk-uikUIkit, Lightbox) {

        if (!yk-uikUIkit.lightboxPanel) {
            yk-uikUIkit.component('lightboxPanel', LightboxPanel);
        }

        assign(
            Lightbox.props,
            yk-uikUIkit.component('lightboxPanel').options.props
        );
    ...
    var notification = {
        ...
        data: {
            ...
            group: null,
            pos: 'top-center',
            clsContainer: 'yk-uik-notification',
            clsClose: 'yk-uik-notification-close',
            clsMsg: 'yk-uik-notification-message'
        },
        ...
        created: function() {
            ...
            this.$mount(append(container,
                ("<div class=\"" + (this.clsMsg) + (this.status ? (" " + (this.clsMsg) + "-" + (this.status)) : '') + "\"> <a href class=\"" + (this.clsClose) + "\" data-yk-uik-close></a> <div>" + (this.message) + "</div> </div>")
            ));
    ...
    function install(yk-uikUIkit) {
        yk-uikUIkit.notification.closeAll = function (group, immediate) {
            apply$1(document.body, function (el) {
                var notification = yk-uikUIkit.getComponent(el, 'notification');
    ...
    var slider = {
        ...
        data: {
            center: false,
            sets: false,
            attrItem: 'yk-uik-slider-item',
            selList: '.yk-uik-slider-items',
            selNav: '.yk-uik-slider-nav',
            clsContainer: 'yk-uik-slider-container',
    ...
    var slideshow = {
        ...
        data: {
            ...
            minHeight: false,
            maxHeight: false,
            selList: '.yk-uik-slideshow-items',
            attrItem: 'yk-uik-slideshow-item',
            selNav: '.yk-uik-slideshow-nav',
    ...
    var sortable = {
        ...
        data: {
            group: false,
            threshold: 5,
            clsItem: 'yk-uik-sortable-item',
            clsPlaceholder: 'yk-uik-sortable-placeholder',
            clsDrag: 'yk-uik-sortable-drag',
            clsDragState: 'yk-uik-drag',
            clsBase: 'yk-uik-sortable',
            clsNoDrag: 'yk-uik-sortable-nodrag',
            clsEmpty: 'yk-uik-sortable-empty',
            clsCustom: '',
            handle: false,
            pos: {}
        },
    ...
    var tooltip = {
        ...
        data: {
            ...
            title: '',
            delay: 0,
            animation: ['yk-uik-animation-scale-up'],
            duration: 100,
            cls: 'yk-uik-active',
            clsPos: 'yk-uik-tooltip'
        },
    ...
    each(components, function (component, name) { return yk-uikUIkit.component(name, component); }
    );
